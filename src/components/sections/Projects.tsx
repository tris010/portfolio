                                    ...
                                    <div className="flex gap-2 relative z-20">
                                        {project.link && (
                                            <a
                                                ...
                                                className="inline-flex items-center px-4 py-2 text-xs font-bold rounded-full bg-white/10 hover:bg-white/20 text-white backdrop-blur-sm transition-colors border border-white/10"
